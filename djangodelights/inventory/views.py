...
from django.viewfrom django.contrib.auth.mixins import LoginRequiredMixins.generic import TemplateView, ListView
...
class NewPurchaseView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["menu_items"] = [
            X for X in MenuItem.objects.all() if X.available()]
        return context
